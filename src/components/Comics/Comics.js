import{API_URL, URL_COMICS, IMG_STANDARD_XLARGE, IMG_NOT_AVAILABLE, URL_CHARACHTERS} from '../../constants/api';
    ...
    renderComics(data){
        ...
        data.forEach(({id, title, thumbnail:{path, extension}})=>{
            ...
            if(path.lastIndexOf(IMG_NOT_AVAILABLE) === -1){
                const uri = API_URL + URL_COMICS + '/' + id + '/' + URL_CHARACHTERS;
